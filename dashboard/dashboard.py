...
with col1:
    ...
    st.altair_chart(
        bar_chart(top5_temp, "temperature", "plant_name", "Top 5 Highest Temperatures"),
        use_container_width=True,
    )

    st.altair_chart(
        bar_chart(low5_temp, "temperature", "plant_name", "Top 5 Lowest Temperatures"),
        use_container_width=True,
    )
...
with col2:
    ...
    st.altair_chart(
        bar_chart(top5_moist, "soil_moisture", "plant_name", "Top 5 Highest Soil Moisture"),
        use_container_width=True,
    )

    st.altair_chart(
        bar_chart(low5_moist, "soil_moisture", "plant_name", "Top 5 Lowest Soil Moisture"),
        use_container_width=True,
    )
